			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('shangpinxinxi','出价记录')" type="warning" @click="offPriceClick(scope.row.id)">出价记录</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
    ...
    // 出价记录
    const offPriceClick = (id) => {
		context?.$router.push('/auctionshangpinxinxi?refid=' + id)
    }
	//初始化
	const init = () => {
		getList()

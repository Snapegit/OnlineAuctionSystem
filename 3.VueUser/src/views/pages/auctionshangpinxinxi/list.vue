	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"0 auto","overflow":"hidden","borderRadius":"4px","background":"#fff","width":"64%","position":"relative"}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('auctionshangpinxinxi','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/auctionshangpinxinxiAdd')
	}
	//判断是否从个人中心跳转
	...
	const detailClick = (id) => {
		router.push('auctionshangpinxinxiDetail?id=' + id + (centerType.value?'&&centerType=1':''))
	}
	//下载文件
	const download = (file) =>{
		if(!file){

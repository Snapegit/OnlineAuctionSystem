	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">竞拍价格</div>
					<div  class="info_text" >{{detail.auctionprice}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">竞拍状态</div>
					<div  class="info_text" >{{detail.auctionstatus}}</div>
				</div>
				<div class="btn_view">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('auctionshangpinxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('auctionshangpinxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
